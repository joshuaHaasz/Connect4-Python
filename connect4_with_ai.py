...
class Connect4AI(Connect4):
	...
	def is_terminal_node(self, board):
		return self.winning_move(self.PLAYER_PIECE) or self.winning_move(self.AI_PIECE) or len(self.get_valid_locations(board)) == 0


	def drop_piece2(self, board, row, col, piece):
		board[row][col] = piece
	...
	def minimax(self, board, depth, alpha, beta, maximizingPlayer):
		...
		if maximizingPlayer:
			...
			for col in valid_locations:
				...
				b_copy = board.copy()
				self.drop_piece2(b_copy, row, col, self.AI_PIECE)
			...
			for col in valid_locations:
				...
				self.drop_piece2(b_copy, row, col, self.PLAYER_PIECE)
